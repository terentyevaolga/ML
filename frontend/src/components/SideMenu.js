...
const accountPages = ['/cabinet', '/course', '/edit'];
            ...
            <div className={styles.cources}>
                ...
                <div className={styles.cources_itemList}>
                    {linksMaterial.map((x, i) =>
                        <p key={i} onClick={() => token && router.push(`/ ${x.link} `)} className={token ? styles.cources_item : styles.cources_itemMainPage}>{x.name}</p>)}
                </div>
            </div>
        </div>
